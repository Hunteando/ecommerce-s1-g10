...
const Contact = () => {
    ...
    const handleSubmit = () => {
        window.open(`https://api.whatsapp.com/send?phone=${number}&text=Hola%20soy%20${nombre},%20${mensaje}`, '_blank')
    }
